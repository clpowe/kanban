...
// .wrangler/tmp/bundle-1rpCZs/checked-fetch.js
  ...
  return /* @__PURE__ */ jsxDEV("li", { "data-id": task.id, children: [
    /* @__PURE__ */ jsxDEV(
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxDEV("input", { type: "text", value: task.title }),
          /* @__PURE__ */ jsxDEV("select", { name: "priority", children: [
...
var TaskList = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxDEV(Fragment, { children: ["todo", "doing", "review", "done"].map((status) => /* @__PURE__ */ jsxDEV("div", { children: [
    ...
    /* @__PURE__ */ jsxDEV("ul", { children: sortTasksByPriority(grouped[status]).map((task) => /* @__PURE__ */ jsxDEV(TaskItem, { task, users: users2 })) })
  ] }, status)) });
}, "TaskList");
...
app.get("/", async (c) => {
  ...
  return c.html(
    /* @__PURE__ */ jsxDEV(Layout, { children: [
      /* @__PURE__ */ jsxDEV(TaskInputForm, { users: usersRes }),
...
// .wrangler/tmp/bundle-1rpCZs/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1rpCZs/middleware-loader.entry.ts
