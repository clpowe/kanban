...
// .wrangler/tmp/bundle-d9EDox/checked-fetch.js
...
// src/components/RewardInputForm.tsx
var RewardInputForm = /* @__PURE__ */ __name(({
  inDrawer = false
}) => {
  return /* @__PURE__ */ jsxDEV("section", { class: "card border border-base-300 bg-base-100 shadow-sm", children: /* @__PURE__ */ jsxDEV("div", { class: "card-body gap-4", children: [
    /* @__PURE__ */ jsxDEV("div", { class: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxDEV("div", { children: [
        /* @__PURE__ */ jsxDEV("h2", { class: "card-title", children: "Add Reward" }),
        /* @__PURE__ */ jsxDEV("p", { class: "text-sm text-base-content/70", children: "Create a reward children can buy with points." })
      ] }),
    ...
    /* @__PURE__ */ jsxDEV(
      "form",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV("button", { class: "btn btn-primary", type: "submit", children: "Add Reward" })
        ]
      }
    )
  ] }) });
...
var Layout = /* @__PURE__ */ __name((props) => {
  ...
  return /* @__PURE__ */ jsxDEV("html", { "data-theme": "light", children: [
    ...
    /* @__PURE__ */ jsxDEV("body", { class: "min-h-screen bg-base-200 text-base-content", children: /* @__PURE__ */ jsxDEV("div", { class: "drawer drawer-end", children: [
      ...
      /* @__PURE__ */ jsxDEV("div", { class: "drawer-content", children: /* @__PURE__ */ jsxDEV("div", { class: "drawer drawer-end", children: [
        /* @__PURE__ */ jsxDEV("input", { id: "score-drawer", type: "checkbox", class: "drawer-toggle" }),
        /* @__PURE__ */ jsxDEV("div", { class: "drawer-content", children: /* @__PURE__ */ jsxDEV("div", { class: "mx-auto flex min-h-screen max-w-8xl flex-col gap-6 px-4 py-6 lg:px-6", children: [
          /* @__PURE__ */ jsxDEV(
            UserSwitcher,
            {
          ...
          /* @__PURE__ */ jsxDEV("div", { class: "card bg-base-100 shadow-sm border border-base-300 p-4", children: [
            /* @__PURE__ */ jsxDEV("h2", { class: "text-2xl", children: props.activeUser.name }),
            /* @__PURE__ */ jsxDEV("p", { children: "Points" }),
            /* @__PURE__ */ jsxDEV("p", { children: props.activeUser.points })
          ] }),
          props.children
        ] }) }),
        /* @__PURE__ */ jsxDEV("div", { class: "drawer-side z-30", children: [
          /* @__PURE__ */ jsxDEV("label", { for: "score-drawer", "aria-label": "close sidebar", class: "drawer-overlay" }),
          /* @__PURE__ */ jsxDEV("div", { class: "flex min-h-full w-full max-w-lg flex-col gap-4 bg-base-200 p-4 sm:p-6", children: [
            /* @__PURE__ */ jsxDEV(
              "section",
              {
                id: "users-container",
      ...
      canCreateTask ? /* @__PURE__ */ jsxDEV("div", { class: "drawer-side z-20", children: [
        ...
        /* @__PURE__ */ jsxDEV("div", { class: "flex min-h-full w-full max-w-lg flex-col gap-4 bg-base-200 p-4 sm:p-6", children: [
          /* @__PURE__ */ jsxDEV(TaskInputForm, { users: props.users, inDrawer: true }),
          /* @__PURE__ */ jsxDEV(RewardInputForm, { inDrawer: true })
        ] })
      ] }) : null
    ] }) })
  ] });
...
__name(canManageTask, "canManageTask");
function canUpdateTaskStatus(user, assigneeId) {
  if (user.type === "parent") {
    return true;
  }
...
var TaskItem = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxDEV(
    "li",
    {
      ...
      children: /* @__PURE__ */ jsxDEV("div", { class: "card-body gap-3 p-2", children: [
        canManage ? /* @__PURE__ */ jsxDEV(
          ...
          /* @__PURE__ */ jsxDEV("h4", { class: "font-bold text-lg", children: task.title }),
        ...
        /* @__PURE__ */ jsxDEV("div", { class: "flex flex-wrap items-center gap-3", children: [
          /* @__PURE__ */ jsxDEV("div", { class: "flex flex-wrap items-start justify-between gap-2", children: /* @__PURE__ */ jsxDEV("div", { class: "flex flex-wrap gap-2", children: [
...
var htmxRefreshResponse = /* @__PURE__ */ __name((c, triggers) => {
  const names = Array.isArray(triggers) ? triggers : [triggers];
  const payload = names.length === 1 ? names[0] : JSON.stringify(names.reduce((acc, name) => {
    acc[name] = true;
    return acc;
  }, {}));
...
var basicAuth = /* @__PURE__ */ __name((options, ...users2) => {
  ...
  if (usernamePasswordInOptions) {
    users2.unshift({ username: options.username, password: options.password });
  }
...
var getUserByUsername = /* @__PURE__ */ __name(async (db, username) => {
  return db.select().from(users).where(eq(users.username, username)).get();
}, "getUserByUsername");
var getTaskAssigneeId = /* @__PURE__ */ __name(async (db, taskId) => {
  const task = await db.select({ assigneeId: tasks.assigneeId }).from(tasks).where(eq(tasks.id, taskId)).get();
  return task?.assigneeId ?? null;
}, "getTaskAssigneeId");

// src/auth/middleware.ts
var FAMILY_SESSION_COOKIE = "family_session";
function serializeFamilySession(session) {
  return JSON.stringify(session);
}
__name(serializeFamilySession, "serializeFamilySession");
function parseFamilySession(value) {
  if (!value) {
    return null;
  }
  try {
    const parsed = JSON.parse(value);
    if (typeof parsed.activeUserId !== "number" || !Array.isArray(parsed.familyUserIds) || parsed.familyUserIds.some((id) => typeof id !== "number")) {
      return null;
    }
    return {
...
__name(parseFamilySession, "parseFamilySession");
function resolveActiveUser(users2, loginUser, sessionValue) {
  ...
  const activeUser = users2.find((user) => user.id === session.activeUserId);
  return activeUser ?? loginUser;
}
__name(resolveActiveUser, "resolveActiveUser");
function validateActiveUserSelection(session, requestedUserId) {
  if (!session.familyUserIds.includes(requestedUserId)) {
    throw new Error("Invalid active user selection");
  }
  return requestedUserId;
}
__name(validateActiveUserSelection, "validateActiveUserSelection");
var basicAuthMiddleware = basicAuth({
  realm: "Family Kanban",
  invalidUserMessage: "Invalid username or password",
  verifyUser: /* @__PURE__ */ __name(async (username, password, c) => {
...
var authMiddleware = /* @__PURE__ */ __name(async (c, next) => {
  ...
  const activeUser = resolveActiveUser(users2, loginUser, sessionValue);
  const nextSession = serializeFamilySession({
    activeUserId: activeUser.id,
    familyUserIds: users2.map((user) => user.id)
  });
...
__name(requireParent, "requireParent");
async function requireChildOwnTaskAccess(c, taskId) {
  const authUser = requireAuthenticatedUser(c);
...
function archivedRoutes(app2, deps = defaultDeps) {
  app2.get("/archived", async (c) => {
    const authUser = deps.requireAuthenticatedUser(c);
    const db = deps.getDB(c.env);
    const users2 = await deps.getAllUsers(db);
  ...
  app2.get("/archived/tasks", async (c) => {
    ...
    const tasks2 = await deps.getArchivedTasks(db, selectedAssigneeId);
    return c.html(
      /* @__PURE__ */ jsxDEV(
        ArchivedTaskList,
        {
...
__name(toRewardView, "toRewardView");
var getAllRewards = /* @__PURE__ */ __name(async (db) => {
  const result = await db.select().from(rewards);
  return result.map(toRewardView);
}, "getAllRewards");
var getRewardById = /* @__PURE__ */ __name(async (db, id) => {
...
var createReward = /* @__PURE__ */ __name(async (db, _parentUser, data) => {
...
var redeemReward = /* @__PURE__ */ __name(async (db, childUser, rewardId) => {
...
__name(normalizeReward, "normalizeReward");
var RewardList = /* @__PURE__ */ __name(({ rewards: rewards2, authUser, showCreateForm = true }) => {
  const items = rewards2.map(normalizeReward);
  const isParent = authUser.type === "parent";
  return /* @__PURE__ */ jsxDEV("section", { class: "space-y-4", children: [
    isParent && showCreateForm ? /* @__PURE__ */ jsxDEV(RewardInputForm, {}) : null,
    /* @__PURE__ */ jsxDEV("section", { class: "card border border-base-300 bg-base-100 shadow-sm", children: /* @__PURE__ */ jsxDEV("div", { class: "card-body gap-4 p-4", children: [
      /* @__PURE__ */ jsxDEV("div", { class: "flex justify-between", children: [
        /* @__PURE__ */ jsxDEV("div", { children: [
          /* @__PURE__ */ jsxDEV("h2", { class: "card-title text-base", children: "Rewards" }),
          /* @__PURE__ */ jsxDEV("p", { class: "text-sm text-base-content/60", children: "Cash in points for family rewards." })
        ] }),
        /* @__PURE__ */ jsxDEV("label", { for: "score-drawer", class: "btn btn-ghost btn-sm btn-circle", children: "\u2715" })
      ] }),
      /* @__PURE__ */ jsxDEV("ul", { class: "space-y-3", children: [
        items.map((reward) => {
          ...
          return /* @__PURE__ */ jsxDEV(
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsxDEV("div", { children: [
                  /* @__PURE__ */ jsxDEV("p", { class: "font-medium", children: reward.title }),
                  /* @__PURE__ */ jsxDEV("p", { class: "text-sm text-base-content/60", children: [
                    reward.cost,
                    " pts"
                  ] })
                ] }),
                isParent ? /* @__PURE__ */ jsxDEV("span", { class: "badge badge-outline", children: [
                  reward.cost,
                  " pts"
                ...
                ) : /* @__PURE__ */ jsxDEV("div", { class: "flex flex-col items-end gap-1", children: [
                  /* @__PURE__ */ jsxDEV("button", { class: "btn btn-disabled btn-sm", disabled: true, children: "Redeem" }),
                  /* @__PURE__ */ jsxDEV("span", { class: "text-xs text-base-content/60", children: [
                    "Need ",
                    shortfall,
                    " more pts"
                  ] })
        ...
        items.length === 0 ? /* @__PURE__ */ jsxDEV("li", { class: "rounded-box border border-dashed border-base-300 px-3 py-5 text-center text-sm text-base-content/60", children: "No rewards yet" }) : null
      ] })
    ] }) })
  ] });
}, "RewardList");
...
function rewardRoutes(app2, deps = defaultDeps2) {
  app2.get("/rewards", async (c) => {
    const authUser = deps.requireAuthenticatedUser(c);
    const db = deps.getDB(c.env);
    const rewards2 = await deps.getAllRewards(db);
    return c.html(
      /* @__PURE__ */ jsxDEV(RewardList, { rewards: rewards2, authUser, showCreateForm: false })
    );
  });
  app2.post("/rewards", async (c) => {
    try {
      const parentUser = deps.requireParent(c);
      const db = deps.getDB(c.env);
      const body = await c.req.parseBody();
      await deps.createReward(db, parentUser, body);
      return deps.htmxRefreshResponse(c, ["refreshRewards", "refreshUsers"]);
    } catch (error) {
  ...
  app2.post("/rewards/:id/redeem", async (c) => {
    const authUser = deps.requireAuthenticatedUser(c);
...
__name(rewardRoutes, "rewardRoutes");

// src/components/UserList.tsx
var UsersList = /* @__PURE__ */ __name(({ users: users2 }) => {
  const topBalance = users2.filter((user) => user.type === "child").reduce((highest, user) => Math.max(highest, user.points), 0);
  return /* @__PURE__ */ jsxDEV("section", { class: "card bg-base-100 shadow-sm border border-base-300", children: /* @__PURE__ */ jsxDEV("div", { class: "card-body p-4", children: [
    /* @__PURE__ */ jsxDEV("div", { class: "flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxDEV("div", { children: [
        /* @__PURE__ */ jsxDEV("h2", { class: "card-title text-base", children: "Family Score" }),
        /* @__PURE__ */ jsxDEV("p", { class: "text-sm text-base-content/60", children: [
          "Track who can cash in rewards next. Top balance: ",
          topBalance,
          " pts"
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxDEV("ul", { class: "divide-y divide-base-300", children: users2.filter((u) => u.type === "child").map((user) => /* @__PURE__ */ jsxDEV("li", { class: "flex items-center justify-between gap-3 py-3", children: [
      ...
      /* @__PURE__ */ jsxDEV("span", { class: "badge badge-primary badge-soft", children: [
        user.points,
        " pts"
      ] })
    ] }, user.id)) })
...
function userRoutes(app2) {
  app2.get("/users", async (c) => {
    ...
    return c.html(/* @__PURE__ */ jsxDEV(UsersList, { users: sortedUsers }));
  });
...
function sessionRoutes(app2) {
  app2.patch("/session/active-user", async (c) => {
    const body = await c.req.parseBody();
...
__name(sessionRoutes, "sessionRoutes");

// src/cron.ts
var resetDailyTasks = /* @__PURE__ */ __name(async (env) => {
...
var handleScheduled = /* @__PURE__ */ __name(async (controller, env, deps = scheduledDeps) => {
  console.log("[CRON] triggered", controller.cron);
  if (controller.cron === "0 0 * * *") {
    await deps.resetDailyTasks({ Bindings: env });
  }
  if (controller.cron === "59 23 * * 6") {
    await deps.archiveCompletedTasks({ Bindings: env });
  }
}, "handleScheduled");
var src_default = {
  fetch: app.fetch,
...
// .wrangler/tmp/bundle-d9EDox/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-d9EDox/middleware-loader.entry.ts
