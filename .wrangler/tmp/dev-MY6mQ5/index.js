...
// .wrangler/tmp/bundle-Y0rdCe/checked-fetch.js
...
function userRoutes(app2) {
  app2.get("/users", async (c) => {
    ...
    return c.html(/* @__PURE__ */ jsxDEV(UsersList, { users: result }));
  });
...
// .wrangler/tmp/bundle-Y0rdCe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Y0rdCe/middleware-loader.entry.ts
