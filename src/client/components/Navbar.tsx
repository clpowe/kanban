...
export default function Navbar() {
  ...
  return (
    <header class="navbar rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-md px-4 py-3 shadow-xl md:px-6 flex-col md:flex-row gap-4 items-stretch justify-between">
      {/* Branding & Info */}
      <div>
        <span class="flex flex-col items-start gap-1">Household Kanban</span>
      ...
      <div class="flex flex-col md:items-end gap-3 w-full md:w-auto max-w-md">
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            class="btn btn-sm rounded-xl font-semibold border-0 bg-slate-800 text-slate-400 hover:bg-rose-500/15 hover:text-rose-400 transition-all duration-200"
          >
            Sign Out
          </button>
          <Show when={isParent()}>
