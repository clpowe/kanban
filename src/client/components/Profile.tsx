                ...
                {(av) => {
                  ...
                  return (
                    <button
                      ...
                      class={`relative rounded-2xl border p-4 flex flex-col items-center gap-2 transition-all duration-200 cursor-pointer ${
                        isActive()
                    ...
                    >
                      ...
                      <div class="text-center">
                        ...
                        <p class="text-[9px] font-bold text-slate-500 mt-0.5 uppercase tracking-wider">
          ...
          <section class="rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-md p-6 shadow-xl flex flex-col gap-4">
            ...
            <div class="grid grid-cols-2 gap-3 mt-1">
              <div class="bg-slate-950/40 border border-slate-800/80 rounded-xl p-3 text-center">
                <span class="text-[9px] font-extrabold uppercase tracking-widest text-slate-500">
                  Completions
                </span>
